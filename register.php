                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo">
                                    <img src="assets/image/webtactic-logo.png" alt="Webtactic logo" width="150px">
                                    <defs>
                                        <path
                        ...
                        <form id="formAuthentication" class="mb-3" action="signup.php" method="POST">
                            ...
                            <button type="submit" name="reg_user" class="btn btn-primary d-grid w-100">Sign up</button>
                        </form>
